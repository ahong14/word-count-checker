 ...
 */
template<class Comparable>
void BinarySearchTree<Comparable>::insert(const Comparable & x, int l) {
	insert(x, root, l);
}
 ...
 */
template<class Comparable>
const Comparable & BinarySearchTree<Comparable>::find(
...
BinarySearchTree<Comparable>::operator=(
		const BinarySearchTree<Comparable> & rhs) {
	if (this != &rhs) {
		makeEmpty();
		root = clone(rhs.root);
...
void BinarySearchTree<Comparable>::insert(const Comparable & x,
	...
	if (t == NULL) {
		...
		t->increment_count(); //MODIFIED INSERT BY INCREMENTING COUNT
		t->add_line(l);
	}

	//MODIFIED COMPARISON WITH CSTRING COMPARISON
		...
		t->increment_count();  // Duplicate; increment count;
		t->add_line(l);
	}
...
template<class Comparable>
void BinaryNode<Comparable>::increment_count() {
	count++;
}

template<class Comparable>
void BinaryNode<Comparable>::add_line(int x) {
	line.enqueue(x);
}
